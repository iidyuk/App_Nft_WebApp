<template>
  <div class="max-w-lg mx-auto mt-20 p-8 bg-white rounded-lg shadow text-center">
    ...
    <p class="mb-6 text-gray-700">Let's make an NFT from this jpg/jpeg file.</p>
    <div class="space-y-4">
      ...
      <br>
      <NuxtLink to="/pinata-test" class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded transition">Pinata API Test</NuxtLink>
    </div>
  </div>
</template>
